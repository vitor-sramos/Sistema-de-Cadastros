...
import vitor.dev.com.Cadastro.Usuario.MapStruct.UsuarioUpdate;
...
public class UsuarioService {
    ...
    private UsuarioUpdate mapperUpdate;
    ...
    public UsuarioResponseDto usuarioUpdate(UsuarioRequestDto requestDto, UUID id) {
        Usuario usuario = repository.findById(id).orElseThrow(
                () -> new RecursoNaoEncontradoException("Usuário não encontrado com id: " + id)
        ) ;
        mapperUpdate.update(requestDto, usuario);
